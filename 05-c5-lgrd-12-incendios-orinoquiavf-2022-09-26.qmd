...
![Imagen Figura1_Ubicacion.png](images/capitulo_5/Figura1_Ubicacion.png)
...
![Imagen Figura3_FocosdeCalor.png](images/capitulo_5/Figura3_FocosdeCalor.png)
...
![Imagen Figura4_area_quemadaMODIS.png](images/capitulo_5/Figura4_area_quemadaMODIS.png)
...
La severidad del incendio se puede describir como el grado en que un área ha sido alterada o interrumpida por el fuego [[31]](#ref-31). Dicha afectación se calculó a través del índice normalizado de área quemada (NBR) y su clasificación se realizó de acuerdo con los rangos de severidad de incendios propuestos por el Servicio Geológico de los Estados Unidos (USGS) (ver Sección 4. Materiales y métodos). En el área de estudio (**Tabla 2** y **3**, y **Fig. 5**), se observa que para el primer período de análisis los departamentos donde se registró “alta severidad” fueron Arauca y Meta, mientras que para el segundo período fueron Casanare y Meta. Este comportamiento cambia cuando se analizan la clase de “moderada/alta” severidad en la cual en el año 2020 el mayor peso lo tiene el departamento de Vichada que se encuentra colindante con Venezuela, mientras que en el 2021 esta categoría está dominada por el Meta.  
...
![Imagen Figura5_dNBR.png](images/capitulo_5/Figura5_dNBR.png)
...
![Imagen Figura6_Ventanas_AQModis.png](images/capitulo_5/Figura6_Ventanas_AQModis.png)

**Figura 6.** Cobertura de los subconjuntos de formato Shapefile [[35]](#ref-35)
...
El dNBR se utilizó para obtener la severidad del incendio, ya que las áreas con valores de dNBR más altos indican daños más severos, mientras que las áreas con valores de dNBR negativos pueden mostrar una mayor productividad de la vegetación [[32]](#ref-32). El dNBR se clasificó de acuerdo con los rangos de severidad de incendios propuestos por el Servicio Geológico de los Estados Unidos (USGS) (**Tabla 5**).
