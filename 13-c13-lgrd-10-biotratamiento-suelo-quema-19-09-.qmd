...
La **Figura 3** presenta un comparativo entre las curvas granulométricas obtenidas sin el uso de ultrason (SU) y sin el uso de defloculante (SD) tanto para la muestra quemada y quemada-tratada, como para el suelo natural, datos que se tomaron de Muñoz para el mismo material sin quemarse y sin tratarse [[32]](#ref-32). Se observa en la figura que la quema del suelo facilita su degradación como lo mostraron Alcañiz et al. [[5]](#ref-5) y Roseno y Camapum de Carvalho [[9]](#ref-9). Ya el tratamiento biotecnológico favoreció su reagregación o el fortalecimiento de las agregaciones o floculaciones presentes [[6]](#ref-6).
