...
Posteriormente, la mitad de las muestras llevadas al horno, se sometieron a tratamiento por goteo con un medio denominado B4 (**Fig. 1**). Según investigaciones previas realizadas en suelos de origen tropical, el medio B4 mejora algunas propiedades y comportamiento geotécnico de los materiales [[6]](#ref-6), [[17]](#ref-17), [[18]](#ref-18). 



**Figura 1.** Proceso de adición del medio B4 en la mitad de las muestras de suelo llevadas al horno.

![Proceso de adición del medio B4 en la mitad de las muestras](images/capitulo_13/Figura 1..jpg)
...
En la Tabla 1 se presentan los valores promedio de algunas propiedades físicas del suelo quemado y del suelo quemado-tratado, y se comparan con los resultados de Díaz et al. [[29]](#ref-29), donde el material estaba compactado en estado natural. Se aclara que el límite líquido y el límite plástico se relacionan con el comportamiento hidromecánico del suelo, en especial con la succión osmótica y las fuerzas de adsorción.
...
![Curvas granulométricas por difracción láser](images/capitulo_13/Figura 2..jpg)
...
![Curvas granulométricas del suelo natural, quemado y quemado-tratado](images/capitulo_13/Figura 3..jpg)
...
Con relación a la mineralogía a partir de la difracción de rayos X (DRX), se encontraron minerales de hematita, caolinita, cuarzo y albita en proporciones similares tanto para el suelo quemado, como para el suelo quemado-tratado (**Fig. 4**), indicando que no se presentaron precipitaciones de nuevos minerales por la acción del tratamiento, o que son trazos imperceptibles en el ensayo, y que por tanto las variaciones han sido más de carácter químico [[6]](#ref-6).
...
![Porcentaje cualitativo de minerales presentes en la muestra](images/capitulo_13/Figura 4..jpg)
...
![Fotografía del estado de las muestras trabajadas](images/capitulo_13/Figura 5..jpg)
...
![Curva característica de retención de agua del suelo](images/capitulo_13/Figura 6..jpg) 
...
![Curvas de fluidez del suelo quemado y quemado-tratado](images/capitulo_13/Figura 7..jpg) 
...
![Curva de consolidación normalizada](images/capitulo_13/Figura 8..jpg)

**Tabla 4.** Índice de colapso (I) en porcentaje según metodología de Jennings & Knight, [[36]](#ref-36). 
...
![Curva Carga hidráulica promedio vs Caudal promedio](images/capitulo_13/Figura 9..jpg)
...
![Ensayo de desagregación en muestra de suelo](images/capitulo_13/Figura 10..jpg) 
