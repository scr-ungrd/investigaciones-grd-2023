...
: Intensidad relativa de eventos de amenaza (A).
...
: Frecuencia relativa de ocurrencia de eventos de amenaza (T).
...
: Calificación de vulnerabilidad a la calidad del agua (Vc). Adaptado de: OMS, 2009.
...
: Calificación de vulnerabilidad a la infraestructura física (Vf). Fuente: Construcción propia.
...
: Justificación calificaciones vulnerabilidad a partir de reuniones colaborativas.
...
: Vulnerabilidad calidad sistema Norte Chingaza.
:::
...
: Vulnerabilidad calidad Sur – Sumapaz.
:::
...
: Vulnerabilidad calidad sistema Tibitoc.
:::
...
: Vulnerabilidad calidad carrotanques.
...
: Asignación de vulnerabilidad química en redes.
...
: Asignación de vulnerabilidad física en redes.
...
: Matriz resumen resultados riesgo por amenazas naturales (escala relativa).
:::
...
: Matriz resumen riesgo por amenazas antrópicas (escala relativa).
:::
