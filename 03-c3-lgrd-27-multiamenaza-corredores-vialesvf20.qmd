...
![Ejemplos de información según ámbitos](images/capitulo_3/Figura 01 Ambitos.png)
...
**Figura 2.** Sección transversal típica de la vía [[20]](#ref-20).

![Sección transversal típica de la vía](images/capitulo_3/Figura 02 Seccion tipica.png)
...
![Estructuras de drenaje y de estabilización de taludes](images/capitulo_3/Figura 03 Diagrama Estructuras.bmp) 
...
![Secuencia metodológica para captura de información y valoración](images/capitulo_3/Figura 05 Secuencia metodologica.png)
...
![Variables para valoración de amenaza y vulnerabilidad](images/capitulo_3/Figura 06 Diagrama variables.bmp)
...
![Muestra de subregistro o falta de completitud](images/capitulo_3/Figura 07 Subregistro.png)
...
![Flujo de información para un proceso de zonificación](images/capitulo_3/Figura 08 Flujo informacion.png)
...
![Formato para levantamiento de elementos viales](images/capitulo_3/Figura 09 Formato remocion.bmp)
...
**Tabla 1.** Nivel de intensidad para inundaciones estáticas y dinámicas. Fuente: Instituto Nicaragüense de Estudios Territoriales y Agencia Suiza para el Desarrollo y la Cooperación [[18]](#ref-18).
...
**Figura 10.** Variables para evaluación de amenaza por inundación en corredores viales [[19]](#ref-19), incluyendo aspectos del medio físico que dan cuenta de la severidad del evento y la susceptibilidad a nivel regional a sufrir inundaciones, así como aspectos propios de las obras de infraestructura que en virtud de su correcta construcción y estado de conservación incrementan o disminuyen la capacidad de respuesta de la infraestructura vial ante la ocurrencia de un evento

![Variables para evaluación de amenaza por inundación](images/capitulo_3/Figura 10 Variables inundacion.bmp)
...
![Rúbrica para valoración de susceptibilidad a inundación](images/capitulo_3/Figura 11 Rubrica inspeccion obras de drenaje.bmp)
...
![Esquema metodológico para definir vulnerabilidad física](images/capitulo_3/Figura 12 Esquema Vulnerabilidad.png)
...
![Alcantarilla localizada en el corredor vial Chiquinquirá–Otanche](images/capitulo_3/Figura 13 Ejemplo vulnerabilidad.bmp)
...
![Inspección visual de una alcantarilla y registro de datos](images/capitulo_3/Figura 14 Inspeccion visual.png)
...
![Survey123 Connect, permite diseñar y publicar formularios](images/capitulo_3/Figura 15 Survey 123.png)
...
![Variables disponibles para captura de información](images/capitulo_3/Figura 16 Variables Survey.png)
...
![Interfaz del aplicativo móvil](images/capitulo_3/Figura 17 Interfaz Survey.png)
...
![Módulos del proceso, captura y almacenamiento](images/capitulo_3/Figura 18 Diagrama Survey.bmp)
...
![Visualización de estadísticas de recuento de puntos](images/capitulo_3/Figura 19.png)
...
![Visualización de puntos de interés en el visor de mapas](images/capitulo_3/Figura 20.png)
...
![Ejemplo de la visualización de resultados y análisis estadístico](images/capitulo_3/Figura 21.png)
